/**
 * http://jquerywidget.com/jquery-emoticons/
 */
;(function(){
    ...
    $.emoticons = function(parameter,getApi) {
        ...
        window.qqFaceContentFormat=function(str){
            return _api.format(str);
        }
        ...
        $document.on('click','.'+options.triggerCls,function(){
            $trigger = $(this);
            var $publisher = $('.'+options.publisherCls);
        ...
        $document.on('click',function(e){
            var $target = $(e.target);
            if(!$target.hasClass(options.triggerCls)&&!$target.parent().hasClass(options.triggerCls)&&!$target.closest('.'+options.prefix+'-layer').length){
                closeLayer();
            }
        });
